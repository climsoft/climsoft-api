...
def search(
    ...
    results = (
        ...
        .filter(
            models.FormHourlywind.stationId.ilike(f"%{_query}%")
            | models.FormHourlywind.yyyy == int(_query)
            | models.FormHourlywind.mm == int(_query)
            | models.FormHourlywind.dd == int(_query)

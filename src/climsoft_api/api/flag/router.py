...
def get_flag_by_id(character_symbol: str, db_session: Session = Depends(deps.get_session)):
    try:
...
def create_flag(data: flag_schema.CreateFlag, db_session: Session = Depends(deps.get_session)):
    try:
        return get_success_response(
...
def update_flag(character_symbol: str, data: flag_schema.UpdateFlag, db_session: Session = Depends(deps.get_session)):
    try:
        return get_success_response(

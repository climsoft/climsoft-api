...
from climsoft_api.db import engine as db_engine
...
def setup_module(module):
    ...
    for i in range(1, 11):
        db_session.add(
            climsoft_models.Acquisitiontype(
...
def test_should_return_single_acquisition_type(
    client: TestClient,
    get_acquisition_type: climsoft_models.Acquisitiontype,
...
def test_should_update_acquisition_type(
    client: TestClient, get_acquisition_type, get_access_token: str
):
    ...
    response = client.put(
        f"/climsoft/v1/acquisition-types/{code}",
...
def test_should_delete_acquisition_type(
    client: TestClient, get_acquisition_type, get_access_token: str
):
    acquisition_type_data = acquisitiontype_schema.AcquisitionType.from_orm(
        get_acquisition_type
